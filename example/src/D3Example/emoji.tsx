...
export default function Emoji(): ReactElement {
  ...
  return (
    <div>
      <div data-testid='use-d3-example-emoji-div' className='h-10 w-full' ref={ref} />
      <p className='font-mono text-right text-sm'><a href="https://observablehq.com/@herrstucki/react-hooks-and-d3">@herrstucki/react-hooks-and-d3</a></p>
    </div>
  )
}